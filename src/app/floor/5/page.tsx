...
export default function Home() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("slideInterval_floor5");
    if (saved) {
  ...
  const slides: React.ReactNode[] = [
    ...
    <div className="flex flex-col h-full gap-4">
      <Header title="5F - 今月のエネルギー消費量データ" />
    ...
    /* ===== 2枚目：今日 ===== */
    <div className="flex flex-col h-full gap-4">
      <Header title="5F - 今日のエネルギー消費量データ" />
    ...
    <div className="flex flex-col h-full gap-4 relative">
      <Header title="5F - 部屋別エネルギー消費量" />

      <div className="grid grid-cols-12 gap-4 flex-1 min-h-0">
        {/* 左 */}
        <div className="col-span-4 grid grid gap-4">
          <GridPanel title="501,502,503 照明" value="-- kWh" className="w-[300px]"/>
          <GridPanel title="504,505,506 照明" value="-- kWh" className="w-[300px]"/>
          <GridPanel title="507,508,509 照明" value="-- kWh" className="w-[300px]"/>
          <GridPanel title="510,511,512 照明" value="-- kWh" className="w-[300px]"/>
        </div>
        ...
        <div className="col-span-4 grid gap-4 justify-self-end">
          <GridPanel title="513,514,515 照明" value="-- kWh" className="w-[300px]"/>
