...
export default function Home() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("slideInterval_floor3");
    if (saved) {
  ...
  const slides: React.ReactNode[] = [
    ...
    <div className="flex flex-col h-full gap-4">
      <Header title="3F - 今月のエネルギー消費量データ" />
    ...
    /* ===== 2枚目：今日 ===== */
    <div className="flex flex-col h-full gap-4">
      <Header title="3F - 今日のエネルギー消費量データ" />
    ...
    <div className="flex flex-col h-full gap-4 relative">
      <Header title="3F - 部屋別エネルギー消費量" />

      <div className="grid grid-cols-12 gap-4 flex-1 min-h-0">
        {/* 左 */}
        <div className="col-span-4 grid grid gap-4">
          <GridPanel title="301 照明" value="-- kWh" className="w-[300px]"/>
          <GridPanel title="302 照明" value="-- kWh" className="w-[300px]"/>
          <GridPanel title="304,305,306,307 照明" value="-- kWh" className="w-[300px]"/>
          <GridPanel title="308,309,310 照明" value="-- kWh" className="w-[300px]"/>
        </div>
        ...
        <div className="col-span-4 grid gap-4 justify-self-end">
          ...
          {/* <GridPanel title=" 照明" value="-- kWh" className="w-[300px]"/> */}
        </div>
      </div>
    </div>,
